...
function renderDrugCards(category = 'all', search = '') {
  ...
  drugsFiltered.forEach(drug => {
    ...
    const thumbSrc = drug.image ? drug.image : 'placeholder_1.svg';
    card.innerHTML = `
